    ...
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className={`flex flex-row items-center py-[6px] px-4 ${bg_discount_gradient} rounded-[10px] mb-2`}>
        ...
        <p className={`${styles.paragraph} ml-2`}>
          <span className="text-white">Next14.2</span> with {" "}
          <span className="text-white">Supabase</span> SSR / SSG
        </p>
      </div>

      <div className="flex flex-row justify-between items-center w-full">
        <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
         NextJs<br className="sm:block hidden" />{" "}
          <span className={`${text_gradient}`}>With</span>{" "}
        </h1>
